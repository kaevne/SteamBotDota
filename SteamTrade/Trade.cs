...
namespace SteamTrade
{
    public partial class Trade
    {
        ...
        public bool AddItem(ulong itemid)
        {
            ...
            {
                return AddItem(new TradeUserAssets() { assetid = itemid, appid = 570, contextid = 2 });
            }
        }
        ...
        public bool RemoveItem(ulong itemid, int appid = 570, long contextid = 2)
        {
        ...
        public string GetItemRarityFromPrivateBp(long contextid, ulong itemID)
        {
            if (OtherPrivateInventory == null)
            {
                // get the foreign inventory
                var f = session.GetForiegnInventory(OtherSID, contextid, 570);
                OtherPrivateInventory = new ForeignInventory(f);
            }

            return OtherPrivateInventory.GetRarity(itemID);
        }

        public string GetItemTrueNameFromPrivateBp(long contextid, ulong itemID)
        {
            if (OtherPrivateInventory == null)
            {
                // get the foreign inventory
            ...
            return OtherPrivateInventory.GetTrueName(itemID);
        }
