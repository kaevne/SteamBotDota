...
namespace SteamBot
{
    public class CommonTradeUserHandler : BaseUserHandler
    {
        public CommonTradeUserHandler(Bot bot, SteamID sid)
            : base(bot, sid)
        {
        ...
        {
            if (schemaItem.Rarity == "Common" && schemaItem.TrueName == "Standard")
            {
                return true;
            }
            else
